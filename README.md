#Susanstripes - Zeek Starter Theme
...
**Important:**  you’ll need to change both the proxy string from `'heisenberg.dev/'` to your local URL and the container string from `'susanstripes'` to your project name. 
